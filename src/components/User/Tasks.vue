    ...
    <v-row no-gutters class="justify-center">
      <v-col lg="12"  align="center">
        <v-card elevation="6" class="pa-5 ma-1">
          <v-card-title class="bg-grey-lighten-2 pa-5 mb-5 ">
            Add New Task
          </v-card-title>
          <v-form fast-fail @submit.prevent="AddTask">
            ...
            ></v-text-field>
            <v-btn type="submit" class="ma-2 bg-purple" rounded="x2"
              >Add Task</v-btn
            >
          </v-form>
        </v-card>
      ...
      <v-col lg="12"  align="center">
        <v-card elevation="6" class="pa-5 ma-1">
          <v-card-title class="bg-grey-2 pa-5 mb-5">
            Your Tasks
          </v-card-title>
          <v-table>
            <thead>
              <tr>
                <th class="text-center bg-light-purple-lighten-3">
                  Task
                </th>
                <th class="text-center bg-light-purple-accent-2">
                  Actions
                </th>
              </tr>
            </thead>
        ...
        <v-card elevation="6" class="pa-5 ma-1">
          <v-form fast-fail @submit.prevent="UpdateTask">
            <v-text-field
              ...
              hint="Enter New Task"
            ></v-text-field>
            <v-btn type="submit" class="ma-2 bg-grey" 
              >Update Task</v-btn
            >
            <v-btn
