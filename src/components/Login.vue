    ...
    <v-row no-gutters class="justify-center pa-15">
      <v-col lg="12"  align="center">
        <v-card elevation="6" class="pa-5">
          <v-card-title class="bg-purple-lighten-1 pa-1 mb-5 ">
            To Keep Connected Please Login<br> With Your Personal Info
          </v-card-title>
          <v-form fast-fail @submit.prevent="singnin()">
            ...
            <v-btn type="submit" class="ma-5 bg-purple" >Login</v-btn>
          </v-form>
        </v-card>
      </v-col>
    </v-row>
